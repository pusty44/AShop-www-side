...
//     * @param bool $testMode
//     */
//    public function __construct($merchantId, $posId, $salt,$testMode = false, responsesService $responsesService)
//    {
//
...
//
//    /**
//     * Check if sms is valid in przelewy24 api
//     * @param string $key
//     * @param string $code
